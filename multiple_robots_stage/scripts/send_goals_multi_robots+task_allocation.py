...
def split_map():
    new = region('dirty', 0, 0.7, 0.7, 9.34, obstacles_y[0])
    regions.append(new)
    new = region('dirty', 1, 0.7, obstacles_y[0]+ob_len, 9.34, obstacles_y[1])
    regions.append(new)
    new = region('dirty', 2, 0.7, obstacles_y[1]+ob_len, 9.34, 9.34)
    regions.append(new)
    new = region('dirty', 3, 0.7, obstacles_y[0], obstacles_x[0], obstacles_y[0]+ob_len)
    regions.append(new)
    ...
    regions.append(new)
    new = region('dirty', 8, obstacles_x[2]+ob_len, obstacles_y[1], 9.34, obstacles_y[1]+ob_len)
    regions.append(new)
